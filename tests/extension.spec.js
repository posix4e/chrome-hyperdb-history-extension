...
test.describe('Chrome Extension Basic Functionality', () => {
  ...
  test.skip('should initialize and connect to the P2P network', async ({ _extensionPage }) => {
    // This test is skipped in CI
  });
  
  test.skip('should display device information', async ({ _extensionPage }) => {
    // This test is skipped in CI
  });
  
  test.skip('should clear stored data when requested', async ({ _extensionPage }) => {
    // This test is skipped in CI
  });
});